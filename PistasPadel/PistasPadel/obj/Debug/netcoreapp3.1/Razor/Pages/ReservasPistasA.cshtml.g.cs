#pragma checksum "C:\Users\curso18-19\Source\Repos\thedragonflu\PistasPadel2\PistasPadel\PistasPadel\Pages\ReservasPistasA.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "13b2f331c1548530b7630341eff9df043ceea0cd"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"13b2f331c1548530b7630341eff9df043ceea0cd", @"/Pages/ReservasPistasA.cshtml")]
    ...
    public class Pages_ReservasPistasA : global::Microsoft.AspNetCore.Mvc.RazorPages.Page
    {
        ...
        {
#nullable restore
#line 3 "C:\Users\curso18-19\Source\Repos\thedragonflu\PistasPadel2\PistasPadel\PistasPadel\Pages\ReservasPistasA.cshtml"
...
<div class=""row text-center"" id=""cuadroTexto"">
    <div class=""alert alert-info text-center invisible"" style=""width: 100%"" id=""alerta"">
        <p id=""mensaje""></p>
        <a class=""btn btn-success"" id=""btnAceptar1"" onclick=""hacerInvisible()"">Aceptar</a>
        ...
        <a class=""btn btn-danger invisible"" id=""btnCancelar2"" onclick=""ha");
            WriteLiteral(@"cerVisible()"">Cancelar</a>
...
#nullable restore
#line 48 "C:\Users\curso18-19\Source\Repos\thedragonflu\PistasPadel2\PistasPadel\PistasPadel\Pages\ReservasPistasA.cshtml"
         for (var i = 9; i <= 21; i++)
        {
...
#nullable restore
#line 51 "C:\Users\curso18-19\Source\Repos\thedragonflu\PistasPadel2\PistasPadel\PistasPadel\Pages\ReservasPistasA.cshtml"
               Write(i);
...
#nullable disable
            WriteLiteral(":00</td>\r\n                <td");
            BeginWriteAttribute("id", " id=\"", 1815, "\"", 1824, 2);
#nullable restore
#line 52 "C:\Users\curso18-19\Source\Repos\thedragonflu\PistasPadel2\PistasPadel\PistasPadel\Pages\ReservasPistasA.cshtml"
WriteAttributeValue("", 1820, i, 1820, 2, false);

#line default
#line hidden
#nullable disable
            WriteAttributeValue("", 1822, "-h", 1822, 2, true);
            EndWriteAttribute();
            WriteLiteral(">Libre</td>\r\n                <td>\r\n                    <a class=\"btn btn-success btn-sm\" style=\"color:white\"");
            BeginWriteAttribute("id", " id=\"", 1933, "\"", 1945, 2);
#nullable restore
#line 54 "C:\Users\curso18-19\Source\Repos\thedragonflu\PistasPadel2\PistasPadel\PistasPadel\Pages\ReservasPistasA.cshtml"
WriteAttributeValue("", 1938, i, 1938, 2, false);

#line default
#line hidden
#nullable disable
            WriteAttributeValue("", 1940, "-btn1", 1940, 5, true);
            EndWriteAttribute();
            BeginWriteAttribute("onclick", " onclick=\"", 1946, "\"", 1988, 7);
            WriteAttributeValue("", 1956, "reserva(this,", 1956, 13, true);
...
#line hidden
#nullable disable
            WriteAttributeValue("", 1973, "-h\',", 1973, 4, true);
...
#line hidden
#nullable disable
            WriteAttributeValue("", 1981, "-btn2\')", 1981, 7, true);
            EndWriteAttribute();
            WriteLiteral(">Reservar</a>\r\n                    <a class=\"btn btn-danger btn-sm invisible\" style=\"color:white\"");
            BeginWriteAttribute("id", " id=\"", 2086, "\"", 2098, 2);
#nullable restore
#line 55 "C:\Users\curso18-19\Source\Repos\thedragonflu\PistasPadel2\PistasPadel\PistasPadel\Pages\ReservasPistasA.cshtml"
WriteAttributeValue("", 2091, i, 2091, 2, false);

#line default
#line hidden
#nullable disable
            WriteAttributeValue("", 2093, "-btn2", 2093, 5, true);
            EndWriteAttribute();
            BeginWriteAttribute("onclick", " onclick=\"", 2099, "\"", 2149, 7);
            WriteAttributeValue("", 2109, "cancelarReserva(this,", 2109, 21, true);
            WriteAttributeValue(" ", 2130, "\'", 2131, 2, true);
#nullable restore
#line 55 "C:\Users\curso18-19\Source\Repos\thedragonflu\PistasPadel2\PistasPadel\PistasPadel\Pages\ReservasPistasA.cshtml"
WriteAttributeValue("", 2132, i, 2132, 2, false);

#line default
#line hidden
#nullable disable
            WriteAttributeValue("", 2134, "-h\',", 2134, 4, true);
            WriteAttributeValue(" ", 2138, "\'", 2139, 2, true);
#nullable restore
#line 55 "C:\Users\curso18-19\Source\Repos\thedragonflu\PistasPadel2\PistasPadel\PistasPadel\Pages\ReservasPistasA.cshtml"
WriteAttributeValue("", 2140, i, 2140, 2, false);

#line default
#line hidden
#nullable disable
            WriteAttributeValue("", 2142, "-btn1\')", 2142, 7, true);
            EndWriteAttribute();
            WriteLiteral(">Cancelar</a>\r\n                </td>\r\n            </tr>\r\n");
#nullable restore
#line 58 "C:\Users\curso18-19\Source\Repos\thedragonflu\PistasPadel2\PistasPadel\PistasPadel\Pages\ReservasPistasA.cshtml"
        }
...
<script>
   ...
   ");
    ...
    function cancelarReserva(elmnt, id, idbtn) {
        ...
        element.previousE");
            WriteLiteral(@"lementSibling.style.background = ""white"";
